...
**Input:**
- Target PDB: `/data/binder_software/BindCraft/runs/15delt3/trial_6_may_20/1lp3_hexamer_trimmed_fixed.pdb` (the full hexamer — RFdiffusion needs to see the steric context of B, C, D, E, F when designing the binder against A)
